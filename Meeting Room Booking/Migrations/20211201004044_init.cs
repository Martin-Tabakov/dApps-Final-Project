        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsInMaintanance = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoardRoomId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeetId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Employees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Employees_Meets_MeetId",
                        column: x => x.MeetId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_MeetId",
                table: "Employees",
                column: "MeetId");

            migrationBuilder.CreateIndex(
                name: "IX_Meets_BoardRoomId",
                table: "Meets",
                column: "BoardRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_Meets_ReserverId",
                table: "Meets",
                column: "ReserverId");
